					...
					<div className="row">
						<div className={`col d-none d-lg-block ${S.leftside}`}>
							<h2 className={S.modalTitle}>
								Pets Do Speak, <br />
								But Only to Those Who <br /> Know How to Listen.
							</h2>
							<p className={S.modalContent}>
								Call our office number to schedule your booking or give
								us your information and will contact you
							</p>
						</div>
							...
							<form action="" className={S.form}>
								...
								<div className={`row  ${S.row}`}>
									<div className="col m-0 p-0">
										...
										<select
											onChange={() => setReasorToVisit(true)}
											className={reasorToVisit && S.active_select}
										>
											<option className={`${S.others} d-none`}>
												Select Reason
											</option>
									...
									<div className="col m-0 p-0">
										...
										<input
											onChange={() => setDateAndTime(true)}
											className={`${S.date_and_time} ${
												dateAndTime && S.active_select
											} `}
											min={new Date().toISOString().slice(0, 16)}
											type="datetime-local"
											defaultValue="2022-10-10T09:59"
										/>
									</div>
								</div>
