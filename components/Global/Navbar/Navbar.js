			...
			<div className={`container ${Styles.container}`}>
				<div className="d-flex justify-content-between align-items-center">
					...
					<div className="menus d-none d-lg-flex align-items-center">
						...
						<div
							className={`${Styles.buttons} d-flex align-items-center`}
						>
							<button>
			...
			<Offcanvas show={show} onHide={handleClose} placement="end">
				<Offcanvas.Body className="m- p-0">
					<div className={Styles.mobileNavWrapper}>
						<div
							className={`${Styles.mHeader} d-flex justify-content-between align-items-center px-3 py-4 border-bottom`}
						>
							<div className={`${Styles.logo}`}>
								<Link href="/">
							...
							<div>
								...
								>
									{" "}
									<AiOutlineCloseCircle className="fs-3" />{" "}
								</button>
							</div>
						</div>
						<div className="menus d-flex flex-column mt-4 align-items-start">
							...
							<div
								className={`${Styles.buttons} ms-4 mt-3 d-flex align-items-center`}
							>
								<button>
									<IoIosCall className="me-1" />
									726-888-9024
